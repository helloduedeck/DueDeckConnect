...
export const getHeaderText = (heading: string, length: number) => {
  try {
...
const ServiceItemCard: React.FC<IProps> = ({
  item,
  isAssigned,
  isCompleted,
  viewableItems,
      ...
      <View>
        <View style={{flexDirection: 'row'}}>
          <View
            ...
            <Text
              style={{
                color: getGStatusColor(item.g_status), // Color based on g_status

...
const OrderingStageaCollapsable = ({id, data}: IProps) => {
            ...
            <View style={styles.column}>
              ...
              <View style={styles.row}>
                <Label
                  size={'small'}
                  fontWeight={'normal'}
                  title={formatDate(item.attended_date)}
  ...
  return (
    <View style={styles.container}>
      <View style={styles.heading}>
        <Text style={styles.headingText}>Ordering Stage 1</Text>
...
export default OrderingStageaCollapsable;
